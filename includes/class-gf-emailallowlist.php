	...
	public function plugin_settings_fields() {
		return array(
			array(
				...
				'description' => esc_html__( 'Use Email Allowlist to secure your forms. If a allowlisted email is used in any email field, the form will error on submission. You can also globally define a list of allowlisted emails and/or domains and a custom validation message if a allowlisted email is submitted. These settings can be overridden on individual email fields in the advanced settings.', 'gf-email-allowlist' ),
				'fields'      => array(
					array(
						'label'   => __( 'Allowlisted Emails', 'gf-email-allowlist' ),
						'type'    => 'textarea',
						'name'    => 'emailallowlist',
						'tooltip' => __( 'Please enter a comma separated list of allowlisted domains (ex. hotmail.com), email addresses (ex. user@aol.com), and/or include the wildcard notation to block top-level domains (ex. *.com). This setting can be overridden on individual email fields in the advanced settings.', 'gf-email-allowlist' ),
						'class'   => 'medium',
					),
					array(
                        ...
                        'default' => __( 'Sorry, the email address entered is not eligible for this form', 'gf-email-allowlist' ),
						'tooltip' => esc_html__( 'Please enter a default error message if a allowlisted email is submitted.', 'gf-email-allowlist' ),
						'class'   => 'medium',
					),
				),
			),
